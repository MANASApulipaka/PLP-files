...
<h1 style = "color : #ffffff; opacity : 1.9;">ACCOUNT CREATION</h1>
    <div class="input-info">
        ...
        <input type="text" name="AccountNumber" placeholder="AccountNumber"required>
          <i class="input"></i>
     <input type="text" name="LOB" placeholder="LOB" list="dr">
      <datalist id="dr">>
      <option name = BA value = "BA">Business Auto</option>
      <option name = Restuarant value = "Restuarant">Restuarant</option>
      <option name = Apartment value = "Apartment">Apartment</option>
      <option name = GenerationMerchant value = "GenerationMerchant">Generation Merchant</option></select>
      </datalist>
